...
- `../output/pdf/bitebud_project_roadmap.pdf` is the generated eight-page project
  and competition roadmap.

Update these notes when a hardware choice, project decision, or working process changes.
